...
export const masterSchedule: {
  ...
  siang: {
    Senin: [
      { mapel: "PAI", start: "12:30", end: "15:10" },
      { mapel: "ISTIRAHAT", start: "15:10", end: "15:40" },
      { mapel: "IPAS", start: "15:40", end: "17:30" },
    ],
    Selasa: [{ mapel: "LIBUR TANGGAL MERAH", start: "00:00", end: "23:59" }],
    Rabu: [
      { mapel: "WAWASAN DUNIA KERJA & K3LH", start: "12:30", end: "14:30" },
      { mapel: "PJOK", start: "14:30", end: "15:10" },
      { mapel: "ISTIRAHAT", start: "15:10", end: "15:40" },
      { mapel: "PJOK", start: "15:40", end: "16:20" },
      { mapel: "KEJURUAN TKJ", start: "16:20", end: "17:30" },
    ],
    Kamis: [
      { mapel: "B.INGGRIS", start: "12:30", end: "13:50" },
      { mapel: "MTK", start: "13:50", end: "15:10" },
      { mapel: "ISTIRAHAT", start: "15:10", end: "15:40" },
      { mapel: "SENI BUDAYA", start: "15:40", end: "16:30" },
      { mapel: "B.INDONESIA", start: "16:30", end: "17:30" },
    ],
    Jumat: [
      { mapel: "KEJURUAN TKJ", start: "12:30", end: "13:50" },
      { mapel: "INFORMATIKA", start: "13:50", end: "15:10" },
      { mapel: "ISTIRAHAT", start: "15:10", end: "15:40" },
      { mapel: "WAWASAN DUNIA KERJA & K3LH", start: "15:40", end: "17:30" },
    ],
    Sabtu: [{ mapel: "LIBUR AKHIR PEKAN", start: "00:00", end: "23:59" }],
    Minggu: [{ mapel: "LIBUR AKHIR PEKAN", start: "00:00", end: "23:59" }],
  },
...
export const paymentHistoryLogs: PaymentHistory[] = [
  {
    name: "AFFAN ASSAKHA",
    date: "15 Agu 2026 - 10:14 WIB",
    code: "Kas-TKJ5-00876-1718291001",
    status: "LUNAS",
    amount: 5000,
  },
  {
    name: "IRFAN DZAKI KHOERULLOH",
    date: "18 Agu 2026 - 14:22 WIB",
    code: "Kas-TKJ5-00812-1718291002",
    status: "LUNAS",
    amount: 5000,
  },
  {
    name: "SUCI WULANDARI",
    date: "21 Agu 2026 - 09:05 WIB",
    code: "Kas-TKJ5-00834-1718291003",
    status: "LUNAS",
    amount: 5000,
  },
  {
    name: "FHABYAN ARRYA RAMADAN",
    date: "23 Agu 2026 - 16:40 WIB",
    code: "Kas-TKJ5-00812-1718291004",
    status: "LUNAS",
    amount: 5000,
  },
];